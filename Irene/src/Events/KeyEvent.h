...
namespace IRENE {
	...
	class IRENE_API KeyEvent : public Event {
	public:
	...
	class IRENE_API KeyPressedEvent : public KeyEvent {
	public:
	...
	class IRENE_API KeyReleasedEvent : public KeyEvent {
	public:
	...
	class IRENE_API KeyTypedEvent : public KeyEvent {
	public:
